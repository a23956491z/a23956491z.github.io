#ifndef ABSTRACT_BST_H_INCLUDED
#define ABSTRACT_BST_H_INCLUDED
 ...
 * @param compare pointer of compare function which could "compare the key and node", <br/>
 *                  we assume the form of function is <code>int func(void* a, void* b)<code/>, <br/>
 *                  and the return form is when "a > b return 1", "a == b return 0", otherwise return -1.
 ...
 */
treeNode_t* deleteNode(treeNode_t** root, void* data, compare_fptr_t compare, swapKey_fptr_t swap);
